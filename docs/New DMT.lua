...
left_section:List({
    ...
    Callback = function(Option)
        ...
        if table.find(Option, "head") then 
            print("You have picked the correct option!!")
        end 
    end 
})
